...
public struct NumberTextField: UIViewRepresentable {
    ...
    public func makeUIView(context: UIViewRepresentableContext<NumberTextField>) -> UITextField {
    ...
    public func updateUIView(_ textField: UITextField, context: UIViewRepresentableContext<NumberTextField>) {
        ...
        if self.value != context.coordinator.internalValue {
            if self.value == nil {
                ...
                let formatter = Formatter.number
                var integer = 0.0
    ...
    public static func dismantleUIView(_ uiView: UITextField, coordinator: NumberTextField.Coordinator) {
        // nothing to cleanup
    }
    ...
    public class Coordinator: NSObject, UITextFieldDelegate {
        ...
        public func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
            ...
            let display = newValue?.numberFormat
...
fileprivate struct Formatter {
    static let number = NumberFormatter(numberStyle: .decimal)
}
